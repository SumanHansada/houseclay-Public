...
export const gymIconURL = `${CDN_BASE_URL}/public/optimizedIcons/small/gym.svg`;
export const outdoorDiningAreaIconURL = `${CDN_BASE_URL}/public/optimizedIcons/small/outdoor-dining-area.svg`;
...
export const firstAidKitIconURL = `${CDN_BASE_URL}/public/optimizedIcons/small/first-aid-kit.svg`;
export const poolTableIconURL = `${CDN_BASE_URL}/public/optimizedIcons/small/pool-table.svg`;
export const wifiIconURL = `${CDN_BASE_URL}/public/optimizedIcons/small/wifi.svg`;
