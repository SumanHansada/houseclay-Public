...
interface EditPropertyDesktopStepperProps {
  currentStep: ListPropertyFormStep;
  completedSteps: Set<ListPropertyFormStep>;
  propertyCategory: PropertyCategory;
}

const EditPropertyDesktopStepper: React.FC<EditPropertyDesktopStepperProps> = ({
  currentStep,
  completedSteps,
  propertyCategory,
}) => {
...
export default EditPropertyDesktopStepper;
