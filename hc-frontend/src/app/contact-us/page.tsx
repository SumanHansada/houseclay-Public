...
const validationSchema = Yup.object({
  ...
  // Added optional validation for subject and message
  subject: Yup.string(),
  message: Yup.string(),
});

// Added subject and message to the initial values
  ...
  return (
    <>
      ...
      <main className="relative w-full">
        {/* --- UNIFIED UPPER Section (Mobile & Desktop) --- */}
        <section className="relative w-full">
          ...
          <div className="relative h-96 sm:h-[400px] md:h-[500px] lg:hidden">
            <div className="absolute inset-0 -z-10">
              <ImageWithLoader
                src="/images/banner-background-contact-us-mobile.svg"
                alt="Banner Background"
                fill
        ...
        {/* --- Form Section (with responsive positioning) --- */}
        <section
          className="
        ...
        <section className="w-full bg-white max-md:mb-16">
          {/* Added top padding to ensure space between form and this section on mobile */}
...
//           {/* Banner as responsive background */}
//           <div className="absolute inset-0 -z-10">
//             <ImageWithLoader
//               src={bannerBackground.src}
//               alt="Banner Background"
...
//             md:absolute md:z-10
//             md:top-16 lg:top-20
//             md:right-14 lg:right-14 xl:right-28
//             lg:w-[45%] xl:w-1/3
//           "
//         >
//           <div className="rounded-xl bg-white shadow-xl border border-gray-200 p-6 md:p-8">
...
//           <div className="xl:px-28 lg:px-14 md:px-14 px-8 pt-10 md:pt-12 lg:pt-16 pb-24 lg:pb-36 xl:pb-56">
//             <div className="text-lg">
//               <p className="w-2/5 xl:w-1/3 mb-8 tracking-wide">
//                 In case you have any questions, reach out to us through the
//                 following channels:
//               </p>
