function InputSkeleton() {
  return <div className="h-10 rounded-lg bg-neutral-200" />;
}

function FormCardSkeleton() {
  return (
    <div className="rounded-xl bg-white lg:shadow-lg border border-gray-200 p-4 sm:p-6 md:p-8">
      <div className="h-7 w-40 mb-6 rounded bg-neutral-200" />
          ...
          <div className="hidden lg:block">
            ...
            <div className="xl:px-24 lg:px-12 md:px-8 px-4 pt-12 md:pt-16 lg:pt-20">
              <div className="w-2/3 space-y-4">
                ...
                <div className="mt-8 h-80 md:w-1/2 lg:w-7/12 xl:w-1/2 rounded bg-neutral-100/70" />
              </div>
            </div>
          </div>
          ...
          <div className="relative h-96 sm:h-[400px] md:h-[500px] lg:hidden">
            ...
            <div className="absolute inset-0 top-5 flex justify-center p-4 sm:p-8 h-fit">
              <div className="space-y-3 w-full md:w-3/4">
                <div className="h-7 w-3/4 mx-auto rounded bg-neutral-100/70" />
                <div className="h-7 w-2/3 mx-auto rounded bg-neutral-100/70" />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="xl:px-24 lg:px-12 md:px-8 px-4 py-8 sm:py-12 lg:py-24 lg:pt-16 lg:pb-36 xl:pb-56">
            <div className="lg:text-lg text-base lg:w-1/2">
              ...
              <div className="flex items-center gap-2 mb-4 w-fit">
                <div className="h-[25px] w-[25px] rounded-full bg-neutral-200" />
                <div className="h-5 w-48 rounded bg-neutral-200" />
              </div>

              {/* Phone row */}
              <div className="flex gap-2 items-start w-fit">
                <div className="h-[25px] w-[25px] rounded-full bg-neutral-200 mt-1" />
