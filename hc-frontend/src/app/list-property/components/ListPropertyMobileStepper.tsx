...
interface ListPropertyMobileStepperProps {
  currentStep: ListPropertyFormStep;
  propertyCategory: PropertyCategory;
  onClose: () => void;
}

const ListPropertyMobileStepper: React.FC<ListPropertyMobileStepperProps> = ({
  currentStep,
  propertyCategory,
  onClose,
}) => {
...
export default ListPropertyMobileStepper;
