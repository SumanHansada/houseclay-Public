...
const Standouts: React.FC<StandoutsProps> = ({
  ...
  return (
    <div className="bg-white bg-center bg-cover flex-col items-center py-20 xl:px-40 lg:px-14 md:px-14 max-md:py-8 px-8 h-full">
      {/* Header Section */}
      ...
      <div className="flex w-full justify-between max-md:justify-around">
        <div className="max-w-4xl mb-4 max-md:mb-8 flex">
          <button
