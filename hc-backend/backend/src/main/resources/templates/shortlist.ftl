          ...
          <table role="presentation" class="container" width="100%" style="max-width:900px; margin:0 auto;">
            ...
            <tr>
              <td class="hero" style="padding-top: 32px;">
                <img src="https://houseclay-email-img.s3.ap-south-1.amazonaws.com/shortlist.png" alt="shortlist illustration">
              </td>
            </tr>
            ...
            <tr>
              <td class="inner">
                ...
                <div class="heading-xl">Property added to your shortlist</div>
                ...
                <p class="p" style="margin-bottom: 24px;">
                  The property ${propertyName?html} has been added to your shortlist.
                </p>
                <p class="p">Access all saved properties from your dashboard anytime.</p>
                  ...
                  <tr>
                    <td align="center">
                      ...
                      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="${(redirectUrl!(baseUrl!'https://houseclay.com'))?html}" style="height:40px;v-text-anchor:middle;width:200px;" arcsize="10%" stroke="f" fillcolor="#ef4444">
                        <w:anchorlock/>
                        <center style="color:#ffffff;font-family:Public Sans, Arial, sans-serif;font-size:16px;font-weight:600;">View Shortlist</center>
                      </v:roundrect>
                      <![endif]-->
                      <!--[if !mso]><!-->
