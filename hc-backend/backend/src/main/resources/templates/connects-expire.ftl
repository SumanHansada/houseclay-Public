          ...
          <table role="presentation" class="container" width="100%" style="max-width:900px; margin:0 auto;">
            ...
            <tr>
              <td class="hero" style="padding-top: 32px;">
                <img src="https://houseclay-email-img.s3.ap-south-1.amazonaws.com/connects-expire.png" alt="expire illustration">
              </td>
            </tr>
            ...
            <tr>
              <td class="inner">
                ...
                <div class="heading-xl">Your connects are about to expire</div>
                ...
                <p class="p" style="margin-bottom: 24px;">
                  Your Connects will expire on ${connectExpiryDate?html}.
                </p>

                <p class="p" style="margin-bottom: 24px;">Renew now to continue contacting property owners without interruption.</p>
                  ...
                  <tr>
                    <td align="center">
                      ...
                      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="${(redirectUrl!(baseUrl!'https://houseclay.com'))?html}" style="height:40px;v-text-anchor:middle;width:200px;" arcsize="10%" stroke="f" fillcolor="#ef4444">
                        <w:anchorlock/>
                        <center style="color:#ffffff;font-family:Public Sans, Arial, sans-serif;font-size:16px;font-weight:600;">Renew Connects</center>
                      </v:roundrect>
                      <![endif]-->
                      <!--[if !mso]><!-->
