          ...
          <table role="presentation" class="container" width="100%" style="max-width:900px; margin:0 auto;">
            ...
            <tr>
              <td class="hero" style="padding-top: 32px;">
                <img src="https://houseclay-email-img.s3.ap-south-1.amazonaws.com/new-lead.png" alt="Welcome illustration">
              </td>
            </tr>
            ...
            <tr>
              <td class="inner">
                ...
                <div class="heading-xl">You've got a new lead!</div>
                ...
                <p class="p" style="margin-bottom: 24px;">
                  Great news! You've received a new lead for your property ${propertyName?html}. 
                  <br /> Log in now to view details and connect directly.
                </p>
                  ...
                  <tr>
                    <td align="center">
                      ...
                      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="${(redirectUrl!(baseUrl!'https://houseclay.com'))?html}" style="height:40px;v-text-anchor:middle;width:200px;" arcsize="10%" stroke="f" fillcolor="#ef4444">
                        <w:anchorlock/>
                        <center style="color:#ffffff;font-family:Public Sans, Arial, sans-serif;font-size:16px;font-weight:600;">View Lead</center>
                      </v:roundrect>
                      <![endif]-->
                      <!--[if !mso]><!-->
                ...
                <p class="p">
                  <b>Tip:</b> The faster you respond, the better your chances of closing the deal.
                </p>
