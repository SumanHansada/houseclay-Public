...
import { dummyGetPropertiesToBeReVerified } from "@/mock/getAllProperties";
...
export const ReVerifyProperties = () => {
  ...
  //     size: rowsPerPage,
  //   });
  const data = dummyGetPropertiesToBeReVerified;
      ...
      <div className="flex flex-col flex-1 h-full">
        ...
        <div className="sticky top-0 z-10 border border-b-gray-200 shadow-sm">
          <SearchFilterBar
            ...
            title={"Properties to be Re-Verified"}
          />
        </div>
